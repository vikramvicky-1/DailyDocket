...
const ExpensesTableSkeleton = () => {
  return (
    <div className="bg-secondary rounded-xl max-sm:p-2 flex flex-col h-full animate-pulse">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between space-y-3 sm:space-y-0 pb-4">
        ...
        <div className="hidden sm:block h-6 sm:h-7 bg-gray-600/30 rounded w-32"></div>
        <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-3 sm:space-y-0 sm:space-x-4">
          <div className="flex items-center space-x-2">
            <div className="h-4 sm:h-5 bg-gray-600/30 rounded w-24"></div>
            <div className="h-5 sm:h-6 bg-gray-600/30 rounded w-28"></div>
          </div>
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar max-h-[520px] md:max-h-[500px] lg:max-h-[450px]">
