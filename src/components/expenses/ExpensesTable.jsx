...
const ExpensesTable = ({ expensesData = [] }) => {
  ...
  const columns = [
    ...
    { key: "billAttachment", label: "Bill Attachment", sortable: false },
          ...
          <div className="max-h-[400px] overflow-y-auto custom-scrollbar">
            {sortedData.length > 0 ? (
              sortedData.map((row, index) => (
                <div
                  key={index}
                  className="grid grid-cols-9 gap-4 p-4 border-b border-gray-700 hover:bg-secondary/50 transition-colors"
                >
                  ...
                  <div className="font-medium text-red text-xs sm:text-sm whitespace-nowrap">
